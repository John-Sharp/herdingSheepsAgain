...
void drawCollisionDiagram(void * pixels, int pitch, void * ctx)
{
    ...
    jint u = e->bluePoint.sTarg[0] ? (800 - e->bluePoint.rStart[0]) / e->bluePoint.sTarg[0] + 1 : 0;
    jint v = e->bluePoint.sTarg[0] ? ((600 - 25) - e->bluePoint.rStart[1]) / e->bluePoint.sTarg[1] + 1 : 0;
    u = u > v ? u : v;
